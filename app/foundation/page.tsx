  ...
  useEffect(() => {
    ...
    if (sanctionHistory) {
      try {
        ...
        const foundationSerialNos = new Set(
          processedFoundations.map((f: any) => f.serialNo)
        );
        processedSanctions = allSanctions.filter(
          (item: SanctionRecord) => !foundationSerialNos.has(item.serialNo)
        );
                      ...
                      <TableBody>
                        {historyItems.map((item) => (
                          <TableRow key={item.serialNo}>
                            ...
                            <TableCell className="whitespace-nowrap bg-green-50/50 text-green-700">
                            ...
                            <TableCell className="whitespace-nowrap bg-green-50/50">
                              {item.challanLink ? (
                                <span className="text-green-600 underline text-xs cursor-pointer">
                                  {item.challanLink}
                                </span>
                              ) : (
                                "-"
                            ...
                            <TableCell className="whitespace-nowrap bg-green-50/50 font-medium text-green-700">
                    ...
                    {historyItems.map((item) => (
                      ...
                      >
                        <CardContent className="p-4 space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-xs border-t border-b py-3 my-2 border-teal-100">
                            <div className="flex flex-col">
                              <span className="text-muted-foreground text-[10px] uppercase">
                                Status
                              </span>
