      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button className="bg-linear-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 shadow-md">
              + Add New Beneficiary
            </Button>
          </DialogTrigger>
          <DialogContent className="max-w-xl max-h-[75vh] md:max-h-[80vh] flex flex-col">
            <DialogHeader className="shrink-0">
              <DialogTitle className="bg-linear-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                <div className="space-y-2">
                  <Label htmlFor="regId" className="text-sm">
                    Reg ID
                  </Label>
                  <Input
                    id="regId"
                ...
                <div className="space-y-2">
                  <Label htmlFor="pumpSource" className="text-sm">
                    Pump Source
                  </Label>
                  <Input
                    id="pumpSource"
                ...
                <div className="space-y-2">
                  <Label htmlFor="pumpType" className="text-sm">
                    Pump Type
                  </Label>
                  <Input
                    id="pumpType"
            ...
            <div className="flex justify-center gap-3 mt-6 pt-4 border-t shrink-0">
            ...
            <>
              ...
              <div className="block md:hidden space-y-4">
                {history.map((item) => (
                  <Card
                    key={item.serialNo}
                    className="p-4 border-l-4 border-l-cyan-500 shadow-sm"
                  >
