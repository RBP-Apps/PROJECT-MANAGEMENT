  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const updatePromises = itemsToProcess.map(async (item) => {
        ...
        addToUpdate(
          "fdMaterialReceivingDate",
          formData.fdMaterialReceivingDate
        );
        addToUpdate("foundationStatus", formData.foundationStatus);
        addToUpdate(
          "foundationCompletionDate",
          formData.foundationCompletionDate
        );
                      ...
                      <TableRow>
                        ...
                        >
                          <div className="flex flex-col items-center justify-center gap-2">
                            ...
                            <p>
                              No pending foundation requests found matching your
                              search
                            </p>
                          </div>
                        </TableCell>
                        ...
                        >
                          ...
                          <TableCell className="whitespace-nowrap bg-green-50/50 font-bold">
                            <Badge
                              ...
                              className={`
                              ${
                                item.foundationStatus === "Completed"
                                  ? "bg-green-100 text-green-700 border-green-200"
                                  : ""
                              }
                              ${
                                item.foundationStatus === "In Progress"
                                  ? "bg-blue-100 text-blue-700 border-blue-200"
                                  : ""
                              }
                              ${
                                item.foundationStatus === "Pending"
                                  ? "bg-yellow-100 text-yellow-700 border-yellow-200"
                                  : ""
                              }
                              ${
                                item.foundationStatus === "On Hold"
                              ...
                              ${
                                ![
                                  ...
                                  "Pending",
                                  "On Hold",
                                ].includes(item.foundationStatus)
