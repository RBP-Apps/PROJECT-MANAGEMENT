...
export default function LoiMrPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      for (let i = headerRowIndex + 1; i < rawRows.length; i++) {
        ...
        const isPlannedFilled =
          item.planned1 && String(item.planned1).trim() !== "";
        const isActualEmpty =
          !item.actual1 || String(item.actual1).trim() === "";
  ...
  const fetchMasterData = async () => {
    try {
      ...
      const shareColIdx = headers.findIndex(
        (h) =>
          h.includes("share") &&
          (h.includes("beneficiary") || h.includes("benificiary"))
      );
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(v) =>
                            setFormData({ ...formData, installer: v })
                          }
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(v) =>
                            setFormData({ ...formData, beneficiaryShare: v })
                          }
                        >
                          <SelectTrigger className="border-slate-200 focus:border-blue-400 focus:ring-blue-100">
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <div
                          ...
                          onClick={() =>
                            document.getElementById("loi-upload")?.click()
                          }
                        >
