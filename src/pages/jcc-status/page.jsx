                          ...
                          <div className="col-span-2">
                            <span className="font-medium text-slate-500">
                             ...
                             <span
                              ...
                              onClick={() => window.open(getPreviewUrl(item.doJccReceivingFile), "_blank")}
                            >
                              View Document
                            </span>
                          </div>
          ...
          <DialogHeader className="p-6 pb-2 border-b border-blue-100 bg-blue-50/30">
            ...
            <DialogDescription className="text-slate-500 ml-10">
              {isBulk ? (
                  ...
                  <span>Enter JCC status details for <span className="font-semibold text-slate-700">{selectedItem?.beneficiaryName}</span></span>
              )}
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Button
                      variant="outline"
                      onClick={() =>
                        document.getElementById("do-jcc-receiving-file")?.click()
                      }
